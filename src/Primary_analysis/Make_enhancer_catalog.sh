...
SE_ctrl_BED="HOMER peak file, superEnhancers.txt (anti-IgM 000 min) is being converted into BED format using following command. Please write path to the converted file here."
...
SE_IgM_BED="HOMER peak file, superEnhancers.txt (anti-IgM 060 min) is being converted into BED format using following command. Please write path to the converted file here."
TE_IgM_BED="As in SE."
