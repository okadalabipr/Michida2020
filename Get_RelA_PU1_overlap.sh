...
cat ${PU1_in_ATAC_in_SE_IgM} ${PU1_in_ATAC_in_TE_IgM} > ${PU1_in_ATAC_in_SE_TE_IgM} #Merge ${PU1_in_ATAC_in_SE_IgM} and ${PU1_in_ATAC_in_TE_IgM}. ${PU1_in_ATAC_in_SE_TE_IgM} is required for for SFig6A.R.
